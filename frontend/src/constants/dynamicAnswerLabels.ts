export const DYNAMIC_ANSWER_ORDERED_KEYS: string[] = [
  "service_type",
  "merged_region",
  // 이사
  "move_type",
...
export const DYNAMIC_ANSWER_LABELS: Record<string, string> = {
  ...
  tl_service_types: "Translation/Interpretation Service Types",
  ...
  vi_service_types: "Translation/Interpretation Service Types",
  ...
  en_service_types: "Translation/Interpretation Service Types",
  en_field: "Field",
  ...
  ml_service_types: "Translation/Interpretation Service Types",
  ...
  wd_local_integration: "Local Payment/Logistics Integration",
