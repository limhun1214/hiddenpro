    ...
    const dummyReviews = [
      {
        service: "에어컨 청소",
        comment:
          "처음 이용해보는데 고수님이 너무 친절하게 설명해주시고 작업도 정말 깔끔하게 마무리해주셨습니다. 다음에도 무조건 이분께 맡기고 싶어요! 강력 추천합니다.",
        rating: 5,
      },
      {
        service: "포장이사",
        comment:
          "이사가 한두 푼 드는게 아니라 걱정 많았는데 합리적인 가격에 파손 하나 없이 완벽하게 이사했습니다. 아침 일찍부터 고생 많으셨습니다.",
        rating: 5,
      },
      {
        service: "인테리어 시공",
        comment:
          "제가 원하는 스타일을 정확히 캐치하셔서 결과물이 너무 만족스럽습니다. 마감 처리도 꼼꼼하고 커뮤니케이션도 원활해서 진행 내내 안심이 되었습니다.",
        rating: 4,
      },
    ];
